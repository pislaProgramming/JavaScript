/*
    Can put arrow functions on one line
*/
let add = (a,b) => a + b;

/*
    Arrow functions do not get their own 'this' keyword and their own arguments!!!
*/
...
{   
    let createObj = (firstName, lastName) => new Object({'firstName' : firstName, 'lastName': lastName});
    return createObj(firstName,lastName);
}
